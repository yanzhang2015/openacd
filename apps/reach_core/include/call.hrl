...
-type(channel_type() :: 'dummy' | 'voice' | 'visual' | 'slow_text' |
	'fast_text').
-type(media_type() :: 'voice' | 'voicemail').
...
-record(call, {
		...
		priority = 40 :: call_priority() | 'undefined',
